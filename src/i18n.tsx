...
export const STRINGS = {
  en: {
    ...
    promo: {
      ...
      advisorRole: 'Representative, JWD Investment',
  ...
  ja: {
    ...
    promo: {
      advisoryEyebrow: '代表による直接のご案内',
      advisorySub: 'FOUNDER-LED ADVISORY',
      advisoryTitle: '失敗も成功も、次の投資家への道しるべに。',
      advisoryBody: '代表・川名智はドバイに住み、投資し、子を育てる。ハート・オブ・ヨーロッパへの個人投資家として、当事者の視点で語ります。ご相談は完全紹介制。まずはお問い合わせください。',
      advisoryCta: 'ご相談のご予約',
      advisorName: '川名 智 (Tomo Kawana)',
      advisorRole: 'JWDインベストメント 代表',
