...
export const STRINGS = {
  en: {
    ...
    instagram: {
      eyebrow: 'INSTAGRAM',
      sub: 'インスタグラム',
      title: 'From Dubai, as it happens',
      body: 'The Heart of Europe, Côte d’Azur Monaco and the Floating Villas — filmed on site and posted as we go.',
      cta: 'View on Instagram',
      note: 'Opens Instagram in a new tab. Some posts are stories and may require you to be signed in.',
      items: [
        { id: 'heart-of-europe',       title: 'Heart of Europe',       url: 'https://www.instagram.com/theheart_of_europe_dubai/' },
        { id: 'cote-dazur-pool',       title: 'Côte d’Azur',           url: 'https://www.instagram.com/reel/Dbya_oYMt8X/' },
        { id: 'cote-dazur-shower',     title: 'Côte d’Azur',           url: 'https://www.instagram.com/vocodubaimonaco?igsh=MW1mNzJsaXlmNDczMQ%3D%3D' },
        { id: 'cool-summer-afternoon', title: 'Cool Summer Afternoon', url: 'https://www.instagram.com/stories/vocodubaimonaco/3958382778829684366?utm_source=ig_story_item_share&igsh=MXJiaWxyNnlxaTdy' },
        { id: 'dubai-cruise',          title: 'Dubai Cruise',          url: 'https://www.instagram.com/stories/highlights/18263987509172700/' },
        { id: 'floating-villa',        title: 'Floating Villa',        url: 'https://www.instagram.com/stories/highlights/18151371379362766/' },
      ],
    },
    closing: {
  ...
  ja: {
    ...
    instagram: {
      ...
      sub: 'INSTAGRAM',
      title: 'ドバイの「今」をそのままに',
      body: 'ハート・オブ・ヨーロッパ、コートダジュール・モナコ、フローティング・ヴィラ。現地で撮影し、そのままお届けしています。',
      cta: 'Instagramで見る',
      note: 'Instagramを新しいタブで開きます。ストーリーズはログインが必要な場合があります。',
      items: [
        { id: 'heart-of-europe',       title: 'ハート・オブ・ヨーロッパ', url: 'https://www.instagram.com/theheart_of_europe_dubai/' },
        { id: 'cote-dazur-pool',       title: 'コートダジュール',       url: 'https://www.instagram.com/reel/Dbya_oYMt8X/' },
        { id: 'cote-dazur-shower',     title: 'コートダジュール',       url: 'https://www.instagram.com/vocodubaimonaco?igsh=MW1mNzJsaXlmNDczMQ%3D%3D' },
        { id: 'cool-summer-afternoon', title: 'クール・サマー・アフタヌーン', url: 'https://www.instagram.com/stories/vocodubaimonaco/3958382778829684366?utm_source=ig_story_item_share&igsh=MXJiaWxyNnlxaTdy' },
        { id: 'dubai-cruise',          title: 'ドバイ・クルーズ',       url: 'https://www.instagram.com/stories/highlights/18263987509172700/' },
        { id: 'floating-villa',        title: 'フローティング・ヴィラ',   url: 'https://www.instagram.com/stories/highlights/18151371379362766/' },
      ],
    },
    closing: {
      eyebrow: 'はじめの一歩',
