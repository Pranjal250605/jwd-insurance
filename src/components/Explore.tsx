            ...
            {t.explore.research.map((c, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="font-serif text-[17px] sm:text-[19px] font-semibold text-slate-900 leading-tight mb-1 truncate">{c.title}</div>
                  <div className="text-[11px] text-slate-500 truncate">{c.meta} · <span className="font-jp">{c.sub}</span></div>
                </div>
